...
public class PositionLog {
	...
	public static void main(String[] args) {
		PositionLog positionLog = new PositionLog("d:\\");
		long position = positionLog.getPosition();
		System.out.println(position);
		try {
			positionLog.initPosition();
		} catch (Exception e) {


		}

		positionLog.setPosition((long) 1231231);
		System.out.println(positionLog.getPosition());
